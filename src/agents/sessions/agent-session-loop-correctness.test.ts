...
import {
  ...
  createTestSessionWithStream,
  disposeAgentSessionLoopTestSessions,
  testModel,
...
type TestSessionOptions = Parameters<typeof createTestSessionWithStream>[1];

function createTestSession(options?: TestSessionOptions) {
  return createTestSessionWithStream(streamMocks.streamSimple, options);
}

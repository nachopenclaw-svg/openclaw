...
type StreamSimple = NonNullable<ProviderConfigInput["streamSimple"]>;
...
export async function createTestSessionWithStream(
...
export function disposeAgentSessionLoopTestSessions(): void {
